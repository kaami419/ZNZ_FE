...
export default function UserPledge() {
  return (
    ...
    <div className={Style.main__container}>
      ...
      The <span>Sparrow</span> User Pledge Terms
      </h2>
      ...
      <div className={Style.general__term}>
        <h2>What Is The “Sparrow User Pledge”?</h2>
      ...
      <div className={Style.general__term}>
        <h2>What Is Excluded From The Sparrow User Pledge?
</h2>
        <div className={Style.desc}>
          <p className={Style.desc__title}>
            We collect and use information for business and commercial
      ...
      <div className={Style.general__term}>
        <h2>The User Pledge Is Not Insurance</h2>
        <div className={Style.desc}>
          <p className={Style.desc__title}>
            We collect and use information for business and commercial
            purposes in accordance with the practices described in this
      ...
      <div className={Style.general__term}>
        <h2>How Do I Submit A User Pledge Claim?</h2>
        <div className={Style.desc}>
          <p className={Style.desc__title}>
            We collect and use information for business and commercial
            purposes in accordance with the practices described in this
